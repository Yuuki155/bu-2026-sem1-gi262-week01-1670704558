...
public class Workshop : MonoBehaviour
{
    ...
    public void As06_GuessingNumberMoreOrLessExample()
    {
        ...
        {
            Debug.Log("TOO FUCKING LOW");
        }
        else if(as06GuessingNumber > as06RandomNumber)
        {
            Debug.Log("TO FUCKING HIGH");
        }
        else
        {
            Debug.Log("Congrats fucker");
        }
    }
    ...
    {
        if (as07Username == "Lianorn" && as07Password == "Masques")
        {
            Debug.Log("Hello!");
            if(as07IsPaid == true)
            {
            ...
            {
                Debug.Log("Holy shit, poor user haha! Laugh at them!");
            }
            if(as07Age > 18)
            {
                Debug.Log("Welcome to adult content");
            }
            else
            {
                Debug.Log("Young fuck get out");
            }
        }
        else
        {
            Debug.Log("Holy shit can't you get anything right?");
        }
    }
}
